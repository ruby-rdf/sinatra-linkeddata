...
* create or respond to an issue for on the [Github Repository](http://github.com/ruby-rdf/sinatra-linkeddata/issues)
* Fork and clone the repo:
  `git clone git@github.com:your-username/sinatra-linkeddata.git`
* Install bundle:
  `bundle install`
...
[pr]:      https://github.com/ruby-rdf/sinatra-linkeddata/compare/
